...
public class EventService implements IEventService{
    ...
    public Event update(Long id, EventRequestDto requestDto) {
        ...
        //Punto de partida existingEvent tiene [Luis, Juan, Maria] updatedSpeakers [Luis, Fernando]
    ...
    public List<Event> getAllEventsAndTheirDetailsOptimizedWithJoinFetch() {
        ...
        events.forEach( event -> {
            ...
            System.out.println("Speaker: "+ event.getSpeakers()
